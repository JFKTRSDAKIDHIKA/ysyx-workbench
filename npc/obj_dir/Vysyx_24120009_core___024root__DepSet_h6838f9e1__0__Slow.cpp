...
VL_ATTR_COLD void Vysyx_24120009_core___024root___ctor_var_reset(Vysyx_24120009_core___024root* vlSelf) {
    ...
    vlSelf->ysyx_24120009_core__DOT__bresp_wire = VL_RAND_RESET_I(2);
    ...
    vlSelf->ysyx_24120009_core__DOT__rresp_wire = VL_RAND_RESET_I(2);
    ...
    vlSelf->ysyx_24120009_core__DOT__wbu__DOT__dmem_rdata_i_delay = VL_RAND_RESET_I(32);
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
    ...
    vlSelf->__Vdly__ysyx_24120009_core__DOT__wbu__DOT__state = VL_RAND_RESET_I(2);
