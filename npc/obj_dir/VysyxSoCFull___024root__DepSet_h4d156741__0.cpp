...
VL_INLINE_OPT void VysyxSoCFull___024root___nba_sequent__TOP__1(VysyxSoCFull___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(vlSelf->ysyxSoCFull__DOT____Vcellinp__flash__ss)) {
        VL_WRITEF("inactive\n");
        ...
        Verilated::runFlushCallbacks();
        __Vdly__ysyxSoCFull__DOT__bitrev__DOT__data_in 
            = (1U | (0xfeU & ((IData)(vlSelf->ysyxSoCFull__DOT__bitrev__DOT__data_in) 
                              << 1U)));
        __Vdly__ysyxSoCFull__DOT__bitrev__DOT__counter 
        ...
        VL_WRITEF("Invalid state[%0t] %%Fatal: bitrev.v:52: Assertion failed in %NysyxSoCFull.bitrev\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        Verilated::runFlushCallbacks();
        VL_STOP_MT("vsrc/perip/bitrev/bitrev.v", 52, "");
    }
...
VL_INLINE_OPT void VysyxSoCFull___024root___nba_sequent__TOP__2(VysyxSoCFull___024root* vlSelf) {
    ...
    vlSelf->__VdfgTmp_hbc06b86d__0 = ((IData)(vlSelf->ysyxSoCFull__DOT__asic__DOT___axi42apb_auto_in_awready)
                                       ? (IData)(vlSelf->ysyxSoCFull__DOT__asic__DOT___axi4frag_auto_out_wstrb)
