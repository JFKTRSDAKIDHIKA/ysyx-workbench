...
VL_ATTR_COLD void Vysyx_24120009_core___024root__trace_init_sub__TOP__0(Vysyx_24120009_core___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+350,"pc_debug", false,-1, 31,0);
    tracep->declBus(c+351,"inst_debug", false,-1, 31,0);
    tracep->declBus(c+352,"reg_write_data_debug", false,-1, 31,0);
    tracep->declBus(c+353,"x2_debug", false,-1, 31,0);
    tracep->declBus(c+354,"waddr_debug", false,-1, 4,0);
    tracep->declBit(c+355,"mem_wen_debug", false,-1);
    tracep->declBit(c+356,"mem_en_debug", false,-1);
    tracep->declBus(c+357,"Op1_debug", false,-1, 31,0);
    tracep->declBus(c+358,"Op2_debug", false,-1, 31,0);
    tracep->declBit(c+359,"rf_we_debug", false,-1);
    tracep->declBit(c+360,"wbu_active_debug", false,-1);
    tracep->declBus(c+361,"imem_addr_debug", false,-1, 31,0);
    tracep->declBus(c+362,"pc_plus4_debug", false,-1, 31,0);
    tracep->declBus(c+363,"wb_sel_debug", false,-1, 1,0);
    tracep->declBus(c+364,"opcode_debug", false,-1, 6,0);
    tracep->declBit(c+365,"pc_wen_debug", false,-1);
    tracep->declBit(c+366,"mem_active_debug", false,-1);
    tracep->declBus(c+367,"result_from_EXU_to_MEM_debug", false,-1, 31,0);
    tracep->declBus(c+368,"result_from_MEM_to_WBU_debug", false,-1, 31,0);
    tracep->declBus(c+369,"result_from_WB_debug", false,-1, 31,0);
    tracep->declBus(c+370,"alu_op_debug", false,-1, 4,0);
    tracep->declBus(c+371,"inst_from_EXU_to_MEM_debug", false,-1, 31,0);
    ...
    tracep->declBit(c+359,"rf_we_debug", false,-1);
    tracep->declBit(c+360,"wbu_active_debug", false,-1);
    tracep->declBus(c+350,"imem_addr_debug", false,-1, 31,0);
    tracep->declBus(c+362,"pc_plus4_debug", false,-1, 31,0);
    tracep->declBus(c+363,"wb_sel_debug", false,-1, 1,0);
    tracep->declBus(c+364,"opcode_debug", false,-1, 6,0);
    tracep->declBit(c+360,"pc_wen_debug", false,-1);
    tracep->declBit(c+366,"mem_active_debug", false,-1);
    tracep->declBus(c+367,"result_from_EXU_to_MEM_debug", false,-1, 31,0);
    tracep->declBus(c+368,"result_from_MEM_to_WBU_debug", false,-1, 31,0);
    tracep->declBus(c+369,"result_from_WB_debug", false,-1, 31,0);
    ...
    tracep->declBus(c+379,"alu_op", false,-1, 4,0);
    tracep->declBus(c+73,"pc_sel", false,-1, 2,0);
    tracep->declBit(c+74,"rf_we", false,-1);
    tracep->declBit(c+380,"mem_en", false,-1);
    tracep->declBit(c+381,"mem_wen", false,-1);
    tracep->declBus(c+382,"wb_sel", false,-1, 1,0);
    tracep->declBus(c+75,"Op1", false,-1, 31,0);
    tracep->declBus(c+76,"Op2", false,-1, 31,0);
    tracep->declBus(c+383,"pc_plus4", false,-1, 31,0);
    ...
    tracep->declBit(c+360,"pc_wen", false,-1);
    tracep->declBus(c+350,"pc_from_IFU_to_IDU", false,-1, 31,0);
    tracep->declBus(c+351,"inst_from_IFU_to_IDU", false,-1, 31,0);
    ...
    tracep->declBus(c+367,"dmem_addr_from_EXU_to_MEM", false,-1, 31,0);
    ...
    tracep->declBus(c+94,"inst_from_WBU_to_MEM", false,-1, 31,0);
    ...
    tracep->declBus(c+367,"dmem_addr", false,-1, 31,0);
    ...
    tracep->declBus(c+357,"op1_result", false,-1, 31,0);
    ...
    tracep->declBus(c+86,"out", false,-1, 31,0);
    tracep->declBus(c+99,"key", false,-1, 4,0);
    tracep->declBus(c+388,"default_out", false,-1, 31,0);
    tracep->declArray(c+113,"lut", false,-1, 406,0);
    ...
    tracep->declBus(c+386,"WIDTH", false,-1, 31,0);
    tracep->declBus(c+391,"RESET_VAL", false,-1, 31,0);
    tracep->declBit(c+348,"clk", false,-1);
    tracep->declBit(c+349,"rst", false,-1);
    ...
    tracep->declBus(c+393,"RESET_VAL", false,-1, 4,0);
    tracep->declBit(c+348,"clk", false,-1);
    tracep->declBit(c+349,"rst", false,-1);
    ...
    tracep->declBus(c+395,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+396,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+179,"out", false,-1, 0,0);
    tracep->declBus(c+176,"key", false,-1, 2,0);
    tracep->declBus(c+397,"default_out", false,-1, 0,0);
    tracep->declBus(c+180,"lut", false,-1, 23,0);
    ...
    tracep->declBit(c+348,"clk", false,-1);
    tracep->declBit(c+349,"rst", false,-1);
    tracep->declBus(c+351,"din", false,-1, 31,0);
    ...
    tracep->declBit(c+348,"clk", false,-1);
    tracep->declBit(c+349,"rst", false,-1);
    tracep->declBus(c+350,"din", false,-1, 31,0);
    ...
    tracep->declBus(c+404,"imem_addr", false,-1, 31,0);
    tracep->declBus(c+228,"inst", false,-1, 31,0);
    tracep->declBus(c+388,"exception", false,-1, 31,0);
    ...
    tracep->declBus(c+367,"dmem_addr_i", false,-1, 31,0);
    ...
    tracep->declBit(c+366,"mem_active", false,-1);
    tracep->declBus(c+351,"inst_from_IFU", false,-1, 31,0);
    tracep->declBus(c+94,"inst_from_WBU", false,-1, 31,0);
    ...
    tracep->declBus(c+262,"shifted_data", false,-1, 31,0);
    tracep->declBus(c+263,"zero_ext_byte", false,-1, 31,0);
    tracep->declBus(c+264,"zero_ext_half", false,-1, 31,0);
    tracep->declBus(c+265,"sign_ext_byte", false,-1, 31,0);
    tracep->declBus(c+266,"sign_ext_half", false,-1, 31,0);
    ...
    tracep->declArray(c+267,"lut", false,-1, 174,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+385,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+395,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+386,"DATA_LEN", false,-1, 31,0);
    ...
    for (int i = 0; i < 5; ++i) {
        tracep->declBus(c+283+i*1,"data_list", true,(i+0), 31,0);
    }
    ...
    tracep->declBus(c+290,"key", false,-1, 9,0);
    tracep->declArray(c+409,"lut", false,-1, 103,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+407,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+408,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+395,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+256,"out", false,-1, 2,0);
    tracep->declBus(c+290,"key", false,-1, 9,0);
    tracep->declBus(c+413,"default_out", false,-1, 2,0);
    tracep->declArray(c+409,"lut", false,-1, 103,0);
    tracep->declBus(c+414,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 8; ++i) {
    ...
    tracep->declBus(c+291,"lut_out", false,-1, 2,0);
    ...
    tracep->declBus(c+255,"wmask", false,-1, 7,0);
    tracep->declBus(c+261,"shift_amount", false,-1, 1,0);
    tracep->declBus(c+293,"base_mask", false,-1, 7,0);
    tracep->declBus(c+255,"shifted_mask", false,-1, 7,0);
    tracep->pushNamePrefix("mem_mux_write ");
    tracep->declBus(c+395,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+395,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+407,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+293,"out", false,-1, 7,0);
    tracep->declBus(c+256,"key", false,-1, 2,0);
    tracep->declQuad(c+416,"lut", false,-1, 32,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+395,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+395,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+407,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+293,"out", false,-1, 7,0);
    tracep->declBus(c+256,"key", false,-1, 2,0);
    tracep->declBus(c+418,"default_out", false,-1, 7,0);
    tracep->declQuad(c+416,"lut", false,-1, 32,0);
    ...
    tracep->declBus(c+385,"ADDR_WIDTH", false,-1, 31,0);
    tracep->declBus(c+386,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+348,"clk", false,-1);
    ...
    tracep->declBit(c+360,"pc_wen", false,-1);
    tracep->declBus(c+351,"inst_from_IFU", false,-1, 31,0);
    tracep->declBit(c+360,"wbu_active", false,-1);
    tracep->declBus(c+94,"inst_o", false,-1, 31,0);
    tracep->declBus(c+362,"pc_plus4_debug", false,-1, 31,0);
    tracep->declBus(c+363,"wb_sel_debug", false,-1, 1,0);
    tracep->declBus(c+364,"opcode_debug", false,-1, 6,0);
    tracep->declBus(c+369,"result_from_WB_debug", false,-1, 31,0);
    tracep->declBus(c+362,"pc_plus4", false,-1, 31,0);
    tracep->declBus(c+328,"pc_o", false,-1, 31,0);
    tracep->declBus(c+329,"result_o", false,-1, 31,0);
    tracep->declBus(c+420,"dmem_addr_o", false,-1, 31,0);
    tracep->declBus(c+330,"dmem_rdata_o", false,-1, 31,0);
    tracep->declBus(c+331,"wb_sel", false,-1, 1,0);
    tracep->declBus(c+332,"funct3", false,-1, 2,0);
    tracep->declBus(c+333,"funct7", false,-1, 6,0);
    tracep->declBus(c+364,"opcode", false,-1, 6,0);
    ...
    tracep->declBus(c+331,"key", false,-1, 1,0);
    tracep->declBus(c+388,"default_out", false,-1, 31,0);
    tracep->declArray(c+374,"lut", false,-1, 135,0);
    tracep->pushNamePrefix("i1 ");
    tracep->declBus(c+398,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+400,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+386,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+396,"HAS_DEFAULT", false,-1, 31,0);
    tracep->declBus(c+72,"out", false,-1, 31,0);
    tracep->declBus(c+331,"key", false,-1, 1,0);
    tracep->declBus(c+388,"default_out", false,-1, 31,0);
    tracep->declArray(c+374,"lut", false,-1, 135,0);
    tracep->declBus(c+401,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 4; ++i) {
        tracep->declQuad(c+334+i*2,"pair_list", true,(i+0), 33,0);
    }
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+68+i*1,"key_list", true,(i+0), 1,0);
    }
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+342+i*1,"data_list", true,(i+0), 31,0);
    }
...
VL_ATTR_COLD void Vysyx_24120009_core___024root__trace_full_sub_0(Vysyx_24120009_core___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+94,(vlSelf->ysyx_24120009_core__DOT__inst_from_WBU_to_MEM),32);
    ...
    bufp->fullIData(oldp+262,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__shifted_data),32);
    bufp->fullIData(oldp+263,((0xffU & vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__shifted_data)),32);
    bufp->fullIData(oldp+264,((0xffffU & vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__shifted_data)),32);
    bufp->fullIData(oldp+265,((((- (IData)((1U & (vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__shifted_data 
                                                  >> 7U)))) 
    ...
    bufp->fullWData(oldp+267,(__Vtemp_hdb58eddb__0),175);
    bufp->fullQData(oldp+273,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__pair_list[0]),35);
    bufp->fullQData(oldp+275,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__pair_list[1]),35);
    bufp->fullQData(oldp+277,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__pair_list[2]),35);
    bufp->fullQData(oldp+279,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__pair_list[3]),35);
    bufp->fullQData(oldp+281,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__pair_list[4]),35);
    bufp->fullIData(oldp+283,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+284,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+285,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+286,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+287,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__data_list[4]),32);
    bufp->fullIData(oldp+288,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+289,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__hit));
    bufp->fullSData(oldp+290,(vlSelf->ysyx_24120009_core__DOT__mem__DOT____Vcellinp__mem_acces_ctl_mux__key),10);
    bufp->fullCData(oldp+291,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__mem_acces_ctl_mux__DOT__i0__DOT__lut_out),3);
    bufp->fullBit(oldp+292,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__mem_acces_ctl_mux__DOT__i0__DOT__hit));
    bufp->fullCData(oldp+293,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__wmask_gen__DOT__base_mask),8);
    bufp->fullCData(oldp+294,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__wmask_gen__DOT__mem_mux_write__DOT__i0__DOT__lut_out),8);
    bufp->fullBit(oldp+295,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__wmask_gen__DOT__mem_mux_write__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+296,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[0]),32);
    bufp->fullIData(oldp+297,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[1]),32);
    bufp->fullIData(oldp+298,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[2]),32);
    bufp->fullIData(oldp+299,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[3]),32);
    bufp->fullIData(oldp+300,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[4]),32);
    bufp->fullIData(oldp+301,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[5]),32);
    bufp->fullIData(oldp+302,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[6]),32);
    bufp->fullIData(oldp+303,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[7]),32);
    bufp->fullIData(oldp+304,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[8]),32);
    bufp->fullIData(oldp+305,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[9]),32);
    bufp->fullIData(oldp+306,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[10]),32);
    bufp->fullIData(oldp+307,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[11]),32);
    bufp->fullIData(oldp+308,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[12]),32);
    bufp->fullIData(oldp+309,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[13]),32);
    bufp->fullIData(oldp+310,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[14]),32);
    bufp->fullIData(oldp+311,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[15]),32);
    bufp->fullIData(oldp+312,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[16]),32);
    bufp->fullIData(oldp+313,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[17]),32);
    bufp->fullIData(oldp+314,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[18]),32);
    bufp->fullIData(oldp+315,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[19]),32);
    bufp->fullIData(oldp+316,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[20]),32);
    bufp->fullIData(oldp+317,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[21]),32);
    bufp->fullIData(oldp+318,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[22]),32);
    bufp->fullIData(oldp+319,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[23]),32);
    bufp->fullIData(oldp+320,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[24]),32);
    bufp->fullIData(oldp+321,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[25]),32);
    bufp->fullIData(oldp+322,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[26]),32);
    bufp->fullIData(oldp+323,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[27]),32);
    bufp->fullIData(oldp+324,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[28]),32);
    bufp->fullIData(oldp+325,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[29]),32);
    bufp->fullIData(oldp+326,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[30]),32);
    bufp->fullIData(oldp+327,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[31]),32);
    bufp->fullIData(oldp+328,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__pc_o),32);
    bufp->fullIData(oldp+329,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__result_o),32);
    bufp->fullIData(oldp+330,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__dmem_rdata_o),32);
    bufp->fullCData(oldp+331,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_sel),2);
    bufp->fullCData(oldp+332,((7U & (vlSelf->ysyx_24120009_core__DOT__inst_from_WBU_to_MEM 
                                     >> 0xcU))),3);
    bufp->fullCData(oldp+333,((vlSelf->ysyx_24120009_core__DOT__inst_from_WBU_to_MEM 
                               >> 0x19U)),7);
    bufp->fullQData(oldp+334,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[0]),34);
    bufp->fullQData(oldp+336,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[1]),34);
    bufp->fullQData(oldp+338,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[2]),34);
    bufp->fullQData(oldp+340,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[3]),34);
    bufp->fullIData(oldp+342,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[0]),32);
    bufp->fullIData(oldp+343,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[1]),32);
    bufp->fullIData(oldp+344,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[2]),32);
    bufp->fullIData(oldp+345,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[3]),32);
    bufp->fullIData(oldp+346,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__lut_out),32);
    bufp->fullBit(oldp+347,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__hit));
    bufp->fullBit(oldp+348,(vlSelf->clk));
    bufp->fullBit(oldp+349,(vlSelf->rst));
    bufp->fullIData(oldp+350,(vlSelf->pc_debug),32);
    bufp->fullIData(oldp+351,(vlSelf->inst_debug),32);
    bufp->fullIData(oldp+352,(vlSelf->reg_write_data_debug),32);
    bufp->fullIData(oldp+353,(vlSelf->x2_debug),32);
    bufp->fullCData(oldp+354,(vlSelf->waddr_debug),5);
    bufp->fullBit(oldp+355,(vlSelf->mem_wen_debug));
    bufp->fullBit(oldp+356,(vlSelf->mem_en_debug));
    bufp->fullIData(oldp+357,(vlSelf->Op1_debug),32);
    bufp->fullIData(oldp+358,(vlSelf->Op2_debug),32);
    bufp->fullBit(oldp+359,(vlSelf->rf_we_debug));
    bufp->fullBit(oldp+360,(vlSelf->wbu_active_debug));
    bufp->fullIData(oldp+361,(vlSelf->imem_addr_debug),32);
    bufp->fullIData(oldp+362,(vlSelf->pc_plus4_debug),32);
    bufp->fullCData(oldp+363,(vlSelf->wb_sel_debug),2);
    ...
    bufp->fullIData(oldp+367,(vlSelf->result_from_EXU_to_MEM_debug),32);
    bufp->fullIData(oldp+368,(vlSelf->result_from_MEM_to_WBU_debug),32);
    bufp->fullIData(oldp+369,(vlSelf->result_from_WB_debug),32);
    bufp->fullCData(oldp+370,(vlSelf->alu_op_debug),5);
    bufp->fullIData(oldp+371,(vlSelf->inst_from_EXU_to_MEM_debug),32);
    bufp->fullBit(oldp+372,(((IData)(vlSelf->mem_active_debug) 
                             & ((3U == (0x7fU & vlSelf->ysyx_24120009_core__DOT__inst_from_MEM_to_WBU)) 
                                | (0x23U == (0x7fU 
                                             & vlSelf->ysyx_24120009_core__DOT__inst_from_MEM_to_WBU))))));
    bufp->fullBit(oldp+373,(((IData)(vlSelf->mem_active_debug) 
    ...
    bufp->fullWData(oldp+374,(__Vtemp_h650a5f8e__0),136);
    bufp->fullCData(oldp+379,(vlSelf->ysyx_24120009_core__DOT__alu_op),5);
    bufp->fullBit(oldp+380,(vlSelf->ysyx_24120009_core__DOT__mem_en));
    bufp->fullBit(oldp+381,(vlSelf->ysyx_24120009_core__DOT__mem_wen));
    bufp->fullCData(oldp+382,(vlSelf->ysyx_24120009_core__DOT__wb_sel),2);
    bufp->fullIData(oldp+383,(vlSelf->ysyx_24120009_core__DOT__pc_plus4),32);
    bufp->fullIData(oldp+384,(0xbU),32);
    bufp->fullIData(oldp+385,(5U),32);
    bufp->fullIData(oldp+386,(0x20U),32);
    bufp->fullIData(oldp+387,(0U),32);
    bufp->fullIData(oldp+388,(0U),32);
    bufp->fullIData(oldp+389,(0x25U),32);
    bufp->fullIData(oldp+390,(0xbU),32);
    bufp->fullIData(oldp+391,(0x80000000U),32);
    bufp->fullBit(oldp+392,(1U));
    bufp->fullCData(oldp+393,(0U),5);
    bufp->fullIData(oldp+394,(6U),32);
    ...
    bufp->fullIData(oldp+400,(2U),32);
    bufp->fullIData(oldp+401,(0x22U),32);
    bufp->fullIData(oldp+402,(2U),32);
    bufp->fullIData(oldp+403,(4U),32);
    bufp->fullIData(oldp+404,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__imem_addr),32);
    bufp->fullIData(oldp+405,(0x23U),32);
    bufp->fullIData(oldp+406,(5U),32);
    bufp->fullIData(oldp+407,(8U),32);
    bufp->fullIData(oldp+408,(0xaU),32);
    ...
    bufp->fullWData(oldp+409,(__Vtemp_ha516852c__0),104);
    bufp->fullCData(oldp+413,(0U),3);
    bufp->fullIData(oldp+414,(0xdU),32);
    bufp->fullIData(oldp+415,(8U),32);
    bufp->fullQData(oldp+416,(0x83c81801ULL),33);
    bufp->fullCData(oldp+418,(0U),8);
    bufp->fullIData(oldp+419,(3U),32);
    bufp->fullIData(oldp+420,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__dmem_addr_o),32);
}
