...
VL_ATTR_COLD void Vysyx_24120009_core___024root__trace_init_sub__TOP__0(Vysyx_24120009_core___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+366,"wb_sel_debug", false,-1, 1,0);
    tracep->declBus(c+367,"opcode_debug", false,-1, 6,0);
    tracep->declBit(c+363,"pc_wen_debug", false,-1);
    tracep->declBit(c+369,"mem_active_debug", false,-1);
    tracep->declBus(c+370,"result_from_EXU_to_MEM_debug", false,-1, 31,0);
    tracep->declBus(c+371,"result_from_MEM_to_WBU_debug", false,-1, 31,0);
    tracep->declBus(c+372,"result_from_WB_debug", false,-1, 31,0);
    ...
    tracep->declBus(c+382,"alu_op", false,-1, 4,0);
    tracep->declBus(c+73,"pc_sel", false,-1, 2,0);
    tracep->declBit(c+321,"rf_we", false,-1);
    tracep->declBit(c+383,"mem_en", false,-1);
    tracep->declBit(c+384,"mem_wen", false,-1);
    tracep->declBus(c+385,"wb_sel", false,-1, 1,0);
    tracep->declBus(c+74,"Op1", false,-1, 31,0);
    tracep->declBus(c+309,"Op2", false,-1, 31,0);
    tracep->declBus(c+386,"pc_plus4", false,-1, 31,0);
    tracep->declBus(c+75,"jump_reg_target", false,-1, 31,0);
    tracep->declBus(c+310,"br_target", false,-1, 31,0);
    tracep->declBus(c+311,"jmp_target", false,-1, 31,0);
    tracep->declBit(c+363,"pc_wen", false,-1);
    ...
    tracep->declBus(c+312,"result_from_EXU_to_MEM", false,-1, 31,0);
    ...
    tracep->declBus(c+312,"Result", false,-1, 31,0);
    tracep->declBus(c+213,"add_result", false,-1, 31,0);
    tracep->declBus(c+214,"sub_result", false,-1, 31,0);
    tracep->declBus(c+313,"slt_result", false,-1, 31,0);
    tracep->declBus(c+314,"sltu_result", false,-1, 31,0);
    tracep->declBus(c+215,"xor_result", false,-1, 31,0);
    tracep->declBus(c+216,"or_result", false,-1, 31,0);
    tracep->declBus(c+217,"and_result", false,-1, 31,0);
    tracep->declBus(c+218,"sll_result", false,-1, 31,0);
    tracep->declBus(c+219,"srl_result", false,-1, 31,0);
    tracep->declBus(c+220,"sra_result", false,-1, 31,0);
    ...
    tracep->declArray(c+221,"lut", false,-1, 406,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+387,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+388,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+389,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+390,"HAS_DEFAULT", false,-1, 31,0);
    tracep->declBus(c+312,"out", false,-1, 31,0);
    tracep->declBus(c+93,"key", false,-1, 4,0);
    tracep->declBus(c+391,"default_out", false,-1, 31,0);
    tracep->declArray(c+221,"lut", false,-1, 406,0);
    tracep->declBus(c+392,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 11; ++i) {
        tracep->declQuad(c+234+i*2,"pair_list", true,(i+0), 36,0);
    }
    for (int i = 0; i < 11; ++i) {
    ...
    tracep->declBus(c+394,"RESET_VAL", false,-1, 31,0);
    tracep->declBit(c+351,"clk", false,-1);
    tracep->declBit(c+352,"rst", false,-1);
    ...
    tracep->declBus(c+388,"WIDTH", false,-1, 31,0);
    tracep->declBus(c+396,"RESET_VAL", false,-1, 4,0);
    tracep->declBit(c+351,"clk", false,-1);
    tracep->declBit(c+352,"rst", false,-1);
    ...
    tracep->declBus(c+310,"br_target_o", false,-1, 31,0);
    tracep->declBus(c+311,"jmp_target_o", false,-1, 31,0);
    tracep->declBus(c+73,"pc_sel", false,-1, 2,0);
    ...
    tracep->declBus(c+116,"out", false,-1, 0,0);
    tracep->declBus(c+113,"key", false,-1, 2,0);
    tracep->declBus(c+400,"default_out", false,-1, 0,0);
    tracep->declBus(c+117,"lut", false,-1, 23,0);
    tracep->declBus(c+401,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 6; ++i) {
    ...
    tracep->declBus(c+403,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+389,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declArray(c+267,"lut", false,-1, 135,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+401,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+403,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+389,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+404,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 4; ++i) {
        tracep->declQuad(c+272+i*2,"pair_list", true,(i+0), 33,0);
    }
    for (int i = 0; i < 4; ++i) {
    ...
    tracep->declBus(c+407,"imem_addr", false,-1, 31,0);
    tracep->declBus(c+305,"inst", false,-1, 31,0);
    tracep->declBus(c+391,"exception", false,-1, 31,0);
    tracep->declBit(c+395,"sram_rd_req", false,-1);
    tracep->declBit(c+306,"rd_res_valid", false,-1);
    ...
    tracep->declBit(c+351,"clk", false,-1);
    tracep->declBit(c+352,"rst", false,-1);
    tracep->declBit(c+395,"rd_req", false,-1);
    tracep->declBus(c+317,"addr", false,-1, 31,0);
    tracep->declBus(c+305,"data_out", false,-1, 31,0);
    tracep->declBit(c+306,"rd_res_valid", false,-1);
    tracep->declBus(c+307,"addr_delayed", false,-1, 31,0);
    tracep->declBit(c+308,"rd_req_delayed", false,-1);
    tracep->popNamePrefix(2);
    ...
    tracep->declBus(c+312,"result_i", false,-1, 31,0);
    ...
    tracep->declBus(c+145,"dmem_wdata_raw", false,-1, 31,0);
    tracep->declBus(c+146,"dmem_wdata", false,-1, 31,0);
    tracep->declBus(c+147,"wmask", false,-1, 7,0);
    tracep->declBus(c+148,"ctl_mem_access", false,-1, 2,0);
    tracep->declBit(c+375,"mem_en", false,-1);
    tracep->declBit(c+376,"mem_wen", false,-1);
    tracep->declBus(c+149,"dmem_addr_o", false,-1, 31,0);
    tracep->declBus(c+145,"rs2_data_o", false,-1, 31,0);
    ...
    tracep->declBus(c+149,"dmem_addr", false,-1, 31,0);
    tracep->declBus(c+148,"control", false,-1, 2,0);
    tracep->declBus(c+322,"data_out", false,-1, 31,0);
    tracep->declBus(c+153,"shift_amount", false,-1, 1,0);
    ...
    tracep->declBus(c+148,"out", false,-1, 2,0);
    tracep->declBus(c+155,"key", false,-1, 9,0);
    tracep->declArray(c+412,"lut", false,-1, 103,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+410,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+411,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+398,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+148,"out", false,-1, 2,0);
    tracep->declBus(c+155,"key", false,-1, 9,0);
    tracep->declBus(c+416,"default_out", false,-1, 2,0);
    tracep->declArray(c+412,"lut", false,-1, 103,0);
    ...
    tracep->declBus(c+156,"lut_out", false,-1, 2,0);
    ...
    tracep->declBus(c+147,"wmask", false,-1, 7,0);
    tracep->declBus(c+153,"shift_amount", false,-1, 1,0);
    tracep->declBus(c+158,"base_mask", false,-1, 7,0);
    tracep->declBus(c+147,"shifted_mask", false,-1, 7,0);
    tracep->pushNamePrefix("mem_mux_write ");
    tracep->declBus(c+398,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+398,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+410,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+158,"out", false,-1, 7,0);
    tracep->declBus(c+148,"key", false,-1, 2,0);
    tracep->declQuad(c+419,"lut", false,-1, 32,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+398,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+398,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+410,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+158,"out", false,-1, 7,0);
    tracep->declBus(c+148,"key", false,-1, 2,0);
    tracep->declBus(c+421,"default_out", false,-1, 7,0);
    tracep->declQuad(c+419,"lut", false,-1, 32,0);
    ...
    tracep->declBus(c+194,"result_o", false,-1, 31,0);
    tracep->declBus(c+423,"dmem_addr_o", false,-1, 31,0);
    tracep->declBus(c+195,"dmem_rdata_o", false,-1, 31,0);
    tracep->declBus(c+196,"wb_sel", false,-1, 1,0);
    ...
    tracep->declBus(c+196,"key", false,-1, 1,0);
    tracep->declBus(c+391,"default_out", false,-1, 31,0);
    tracep->declArray(c+377,"lut", false,-1, 135,0);
    tracep->pushNamePrefix("i1 ");
    tracep->declBus(c+401,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+403,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+389,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+399,"HAS_DEFAULT", false,-1, 31,0);
    tracep->declBus(c+72,"out", false,-1, 31,0);
    tracep->declBus(c+196,"key", false,-1, 1,0);
    tracep->declBus(c+391,"default_out", false,-1, 31,0);
    tracep->declArray(c+377,"lut", false,-1, 135,0);
...
VL_ATTR_COLD void Vysyx_24120009_core___024root__trace_full_sub_0(Vysyx_24120009_core___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+144,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__mux_pc_sel__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+145,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__rs2_data_o),32);
    bufp->fullIData(oldp+146,(((0x1fU >= (0x18U & (vlSelf->ysyx_24120009_core__DOT__mem__DOT__dmem_addr_o 
                                                   << 3U)))
                                ? (vlSelf->ysyx_24120009_core__DOT__mem__DOT__rs2_data_o 
                                   << (0x18U & (vlSelf->ysyx_24120009_core__DOT__mem__DOT__dmem_addr_o 
                                                << 3U)))
                                : 0U)),32);
    bufp->fullCData(oldp+147,((0xffU & ((IData)(vlSelf->ysyx_24120009_core__DOT__mem__DOT__wmask_gen__DOT__base_mask) 
                                        << (3U & vlSelf->ysyx_24120009_core__DOT__mem__DOT__dmem_addr_o)))),8);
    bufp->fullCData(oldp+148,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__ctl_mem_access),3);
    bufp->fullIData(oldp+149,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__dmem_addr_o),32);
    bufp->fullCData(oldp+150,((7U & (vlSelf->ysyx_24120009_core__DOT__inst_from_MEM_to_WBU 
                                     >> 0xcU))),3);
    bufp->fullCData(oldp+151,((vlSelf->ysyx_24120009_core__DOT__inst_from_MEM_to_WBU 
                               >> 0x19U)),7);
    bufp->fullCData(oldp+152,((0x7fU & vlSelf->ysyx_24120009_core__DOT__inst_from_MEM_to_WBU)),7);
    bufp->fullCData(oldp+153,((3U & vlSelf->ysyx_24120009_core__DOT__mem__DOT__dmem_addr_o)),2);
    bufp->fullBit(oldp+154,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__hit));
    bufp->fullSData(oldp+155,(vlSelf->ysyx_24120009_core__DOT__mem__DOT____Vcellinp__mem_acces_ctl_mux__key),10);
    bufp->fullCData(oldp+156,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__mem_acces_ctl_mux__DOT__i0__DOT__lut_out),3);
    bufp->fullBit(oldp+157,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__mem_acces_ctl_mux__DOT__i0__DOT__hit));
    bufp->fullCData(oldp+158,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__wmask_gen__DOT__base_mask),8);
    bufp->fullCData(oldp+159,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__wmask_gen__DOT__mem_mux_write__DOT__i0__DOT__lut_out),8);
    bufp->fullBit(oldp+160,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__wmask_gen__DOT__mem_mux_write__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+161,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[0]),32);
    bufp->fullIData(oldp+162,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[1]),32);
    bufp->fullIData(oldp+163,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[2]),32);
    bufp->fullIData(oldp+164,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[3]),32);
    bufp->fullIData(oldp+165,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[4]),32);
    bufp->fullIData(oldp+166,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[5]),32);
    bufp->fullIData(oldp+167,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[6]),32);
    bufp->fullIData(oldp+168,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[7]),32);
    bufp->fullIData(oldp+169,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[8]),32);
    bufp->fullIData(oldp+170,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[9]),32);
    bufp->fullIData(oldp+171,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[10]),32);
    bufp->fullIData(oldp+172,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[11]),32);
    bufp->fullIData(oldp+173,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[12]),32);
    bufp->fullIData(oldp+174,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[13]),32);
    bufp->fullIData(oldp+175,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[14]),32);
    bufp->fullIData(oldp+176,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[15]),32);
    bufp->fullIData(oldp+177,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[16]),32);
    bufp->fullIData(oldp+178,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[17]),32);
    bufp->fullIData(oldp+179,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[18]),32);
    bufp->fullIData(oldp+180,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[19]),32);
    bufp->fullIData(oldp+181,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[20]),32);
    bufp->fullIData(oldp+182,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[21]),32);
    bufp->fullIData(oldp+183,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[22]),32);
    bufp->fullIData(oldp+184,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[23]),32);
    bufp->fullIData(oldp+185,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[24]),32);
    bufp->fullIData(oldp+186,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[25]),32);
    bufp->fullIData(oldp+187,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[26]),32);
    bufp->fullIData(oldp+188,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[27]),32);
    bufp->fullIData(oldp+189,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[28]),32);
    bufp->fullIData(oldp+190,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[29]),32);
    bufp->fullIData(oldp+191,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[30]),32);
    bufp->fullIData(oldp+192,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[31]),32);
    bufp->fullIData(oldp+193,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__pc_o),32);
    bufp->fullIData(oldp+194,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__result_o),32);
    bufp->fullIData(oldp+195,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__dmem_rdata_o),32);
    bufp->fullCData(oldp+196,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_sel),2);
    bufp->fullCData(oldp+197,((7U & (vlSelf->ysyx_24120009_core__DOT__inst_from_WBU_to_MEM 
                                     >> 0xcU))),3);
    bufp->fullCData(oldp+198,((vlSelf->ysyx_24120009_core__DOT__inst_from_WBU_to_MEM 
                               >> 0x19U)),7);
    bufp->fullQData(oldp+199,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[0]),34);
    bufp->fullQData(oldp+201,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[1]),34);
    bufp->fullQData(oldp+203,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[2]),34);
    bufp->fullQData(oldp+205,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[3]),34);
    bufp->fullIData(oldp+207,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[0]),32);
    bufp->fullIData(oldp+208,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[1]),32);
    bufp->fullIData(oldp+209,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[2]),32);
    bufp->fullIData(oldp+210,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[3]),32);
    bufp->fullIData(oldp+211,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__lut_out),32);
    bufp->fullBit(oldp+212,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__hit));
    bufp->fullIData(oldp+213,((vlSelf->ysyx_24120009_core__DOT__Op1 
    ...
    bufp->fullIData(oldp+217,((vlSelf->ysyx_24120009_core__DOT__Op1 
                               & vlSelf->ysyx_24120009_core__DOT__Op2)),32);
    bufp->fullIData(oldp+218,(((0x1fU >= (0x1fU & vlSelf->ysyx_24120009_core__DOT__Op2))
    ...
    __Vtemp_hd74bf4d1__0[0xcU] = ((vlSelf->ysyx_24120009_core__DOT__Op1 
                                   + vlSelf->ysyx_24120009_core__DOT__Op2) 
                                  >> 0xeU);
    bufp->fullWData(oldp+221,(__Vtemp_hd74bf4d1__0),407);
    bufp->fullQData(oldp+234,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__pair_list[0]),37);
    bufp->fullQData(oldp+236,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__pair_list[1]),37);
    bufp->fullQData(oldp+238,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__pair_list[2]),37);
    bufp->fullQData(oldp+240,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__pair_list[3]),37);
    bufp->fullQData(oldp+242,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__pair_list[4]),37);
    bufp->fullQData(oldp+244,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__pair_list[5]),37);
    bufp->fullQData(oldp+246,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__pair_list[6]),37);
    bufp->fullQData(oldp+248,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__pair_list[7]),37);
    bufp->fullQData(oldp+250,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__pair_list[8]),37);
    bufp->fullQData(oldp+252,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__pair_list[9]),37);
    bufp->fullQData(oldp+254,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__pair_list[10]),37);
    bufp->fullIData(oldp+256,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+257,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+258,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+259,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+260,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__data_list[4]),32);
    bufp->fullIData(oldp+261,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__data_list[5]),32);
    bufp->fullIData(oldp+262,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__data_list[6]),32);
    bufp->fullIData(oldp+263,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__data_list[7]),32);
    bufp->fullIData(oldp+264,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__data_list[8]),32);
    bufp->fullIData(oldp+265,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__data_list[9]),32);
    bufp->fullIData(oldp+266,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__data_list[10]),32);
    ...
    __Vtemp_h4b1a9c47__0[4U] = (vlSelf->ysyx_24120009_core__DOT__ifu__DOT__pc 
                                >> 0x1aU);
    bufp->fullWData(oldp+267,(__Vtemp_h4b1a9c47__0),136);
    bufp->fullQData(oldp+272,(vlSelf->ysyx_24120009_core__DOT__idu__DOT__op2_sel_mux__DOT__i0__DOT__pair_list[0]),34);
    bufp->fullQData(oldp+274,(vlSelf->ysyx_24120009_core__DOT__idu__DOT__op2_sel_mux__DOT__i0__DOT__pair_list[1]),34);
    bufp->fullQData(oldp+276,(vlSelf->ysyx_24120009_core__DOT__idu__DOT__op2_sel_mux__DOT__i0__DOT__pair_list[2]),34);
    bufp->fullQData(oldp+278,(vlSelf->ysyx_24120009_core__DOT__idu__DOT__op2_sel_mux__DOT__i0__DOT__pair_list[3]),34);
    bufp->fullIData(oldp+280,(vlSelf->ysyx_24120009_core__DOT__idu__DOT__op2_sel_mux__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+281,(vlSelf->ysyx_24120009_core__DOT__idu__DOT__op2_sel_mux__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+282,(vlSelf->ysyx_24120009_core__DOT__idu__DOT__op2_sel_mux__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+283,(vlSelf->ysyx_24120009_core__DOT__idu__DOT__op2_sel_mux__DOT__i0__DOT__data_list[3]),32);
    ...
    __Vtemp_h47858337__0[5U] = (((IData)(4U) + vlSelf->ysyx_24120009_core__DOT__ifu__DOT__pc) 
                                >> 0x14U);
    bufp->fullWData(oldp+284,(__Vtemp_h47858337__0),175);
    bufp->fullQData(oldp+290,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__mux_pc_sel__DOT__i0__DOT__pair_list[0]),35);
    bufp->fullQData(oldp+292,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__mux_pc_sel__DOT__i0__DOT__pair_list[1]),35);
    bufp->fullQData(oldp+294,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__mux_pc_sel__DOT__i0__DOT__pair_list[2]),35);
    bufp->fullQData(oldp+296,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__mux_pc_sel__DOT__i0__DOT__pair_list[3]),35);
    bufp->fullQData(oldp+298,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__mux_pc_sel__DOT__i0__DOT__pair_list[4]),35);
    bufp->fullIData(oldp+300,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__mux_pc_sel__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+301,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__mux_pc_sel__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+302,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__mux_pc_sel__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+303,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__mux_pc_sel__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+304,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__mux_pc_sel__DOT__i0__DOT__data_list[4]),32);
    bufp->fullIData(oldp+305,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__inst),32);
    bufp->fullBit(oldp+306,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__rd_res_valid));
    bufp->fullIData(oldp+307,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__sram_inst__DOT__addr_delayed),32);
    bufp->fullBit(oldp+308,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__sram_inst__DOT__rd_req_delayed));
    bufp->fullIData(oldp+309,(vlSelf->ysyx_24120009_core__DOT__Op2),32);
    bufp->fullIData(oldp+310,(vlSelf->ysyx_24120009_core__DOT__br_target),32);
    bufp->fullIData(oldp+311,(vlSelf->ysyx_24120009_core__DOT__jmp_target),32);
    bufp->fullIData(oldp+312,(vlSelf->ysyx_24120009_core__DOT__result_from_EXU_to_MEM),32);
    bufp->fullIData(oldp+313,(vlSelf->__VdfgTmp_h9d12977d__0),32);
    bufp->fullIData(oldp+314,(vlSelf->__VdfgTmp_h9d0653ad__0),32);
    bufp->fullIData(oldp+315,(vlSelf->ysyx_24120009_core__DOT__exu__DOT__alu_instance__DOT__alu_mux__DOT__i0__DOT__lut_out),32);
    bufp->fullIData(oldp+316,(vlSelf->ysyx_24120009_core__DOT__idu__DOT__op2_sel_mux__DOT__i0__DOT__lut_out),32);
    ...
    bufp->fullIData(oldp+320,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__mux_pc_sel__DOT__i0__DOT__lut_out),32);
    ...
    bufp->fullBit(oldp+375,(((IData)(vlSelf->mem_active_debug) 
    ...
    bufp->fullWData(oldp+377,(__Vtemp_h650a5f8e__0),136);
    bufp->fullCData(oldp+382,(vlSelf->ysyx_24120009_core__DOT__alu_op),5);
    bufp->fullBit(oldp+383,(vlSelf->ysyx_24120009_core__DOT__mem_en));
    bufp->fullBit(oldp+384,(vlSelf->ysyx_24120009_core__DOT__mem_wen));
    bufp->fullCData(oldp+385,(vlSelf->ysyx_24120009_core__DOT__wb_sel),2);
    bufp->fullIData(oldp+386,(vlSelf->ysyx_24120009_core__DOT__pc_plus4),32);
    bufp->fullIData(oldp+387,(0xbU),32);
    bufp->fullIData(oldp+388,(5U),32);
    bufp->fullIData(oldp+389,(0x20U),32);
    bufp->fullIData(oldp+390,(0U),32);
    bufp->fullIData(oldp+391,(0U),32);
    bufp->fullIData(oldp+392,(0x25U),32);
    ...
    bufp->fullIData(oldp+402,(6U),32);
    bufp->fullIData(oldp+403,(2U),32);
    bufp->fullIData(oldp+404,(0x22U),32);
    bufp->fullIData(oldp+405,(2U),32);
    bufp->fullIData(oldp+406,(4U),32);
    bufp->fullIData(oldp+407,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__imem_addr),32);
    bufp->fullIData(oldp+408,(0x23U),32);
    bufp->fullIData(oldp+409,(5U),32);
    bufp->fullIData(oldp+410,(8U),32);
    bufp->fullIData(oldp+411,(0xaU),32);
    ...
    bufp->fullWData(oldp+412,(__Vtemp_ha516852c__0),104);
    bufp->fullCData(oldp+416,(0U),3);
    bufp->fullIData(oldp+417,(0xdU),32);
    bufp->fullIData(oldp+418,(8U),32);
    bufp->fullQData(oldp+419,(0x83c81801ULL),33);
    bufp->fullCData(oldp+421,(0U),8);
    bufp->fullIData(oldp+422,(3U),32);
    bufp->fullIData(oldp+423,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__dmem_addr_o),32);
}
