...
VL_ATTR_COLD void Vysyx_24120009_core___024root__trace_init_sub__TOP__0(Vysyx_24120009_core___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+351,"pc_debug", false,-1, 31,0);
    tracep->declBus(c+352,"inst_debug", false,-1, 31,0);
    tracep->declBus(c+353,"reg_write_data_debug", false,-1, 31,0);
    tracep->declBus(c+354,"x2_debug", false,-1, 31,0);
    tracep->declBus(c+355,"waddr_debug", false,-1, 4,0);
    tracep->declBit(c+356,"mem_wen_debug", false,-1);
    tracep->declBit(c+357,"mem_en_debug", false,-1);
    tracep->declBus(c+358,"Op1_debug", false,-1, 31,0);
    tracep->declBus(c+359,"Op2_debug", false,-1, 31,0);
    tracep->declBit(c+360,"rf_we_debug", false,-1);
    tracep->declBit(c+361,"wbu_active_debug", false,-1);
    tracep->declBus(c+362,"imem_addr_debug", false,-1, 31,0);
    tracep->declBus(c+363,"pc_plus4_debug", false,-1, 31,0);
    tracep->declBus(c+364,"wb_sel_debug", false,-1, 1,0);
    tracep->declBus(c+365,"opcode_debug", false,-1, 6,0);
    tracep->declBit(c+366,"pc_wen_debug", false,-1);
    tracep->declBit(c+367,"mem_active_debug", false,-1);
    ...
    tracep->declBit(c+360,"rf_we_debug", false,-1);
    tracep->declBit(c+361,"wbu_active_debug", false,-1);
    tracep->declBus(c+351,"imem_addr_debug", false,-1, 31,0);
    tracep->declBus(c+363,"pc_plus4_debug", false,-1, 31,0);
    tracep->declBus(c+364,"wb_sel_debug", false,-1, 1,0);
    tracep->declBus(c+365,"opcode_debug", false,-1, 6,0);
    tracep->declBit(c+361,"pc_wen_debug", false,-1);
    tracep->declBit(c+367,"mem_active_debug", false,-1);
    ...
    tracep->declBit(c+361,"pc_wen", false,-1);
    tracep->declBus(c+351,"pc_from_IFU_to_IDU", false,-1, 31,0);
    tracep->declBus(c+352,"inst_from_IFU_to_IDU", false,-1, 31,0);
    ...
    tracep->declBus(c+358,"op1_result", false,-1, 31,0);
    ...
    tracep->declBit(c+367,"mem_active", false,-1);
    tracep->declBus(c+352,"inst_from_IFU", false,-1, 31,0);
    ...
    tracep->declBit(c+361,"pc_wen", false,-1);
    tracep->declBus(c+352,"inst_from_IFU", false,-1, 31,0);
    tracep->declBit(c+361,"wbu_active", false,-1);
    tracep->declBus(c+363,"pc_plus4_debug", false,-1, 31,0);
    tracep->declBus(c+364,"wb_sel_debug", false,-1, 1,0);
    tracep->declBus(c+365,"opcode_debug", false,-1, 6,0);
    tracep->declBus(c+363,"pc_plus4", false,-1, 31,0);
    tracep->declBus(c+328,"inst_o", false,-1, 31,0);
    tracep->declBus(c+329,"pc_o", false,-1, 31,0);
    tracep->declBus(c+330,"result_o", false,-1, 31,0);
    tracep->declBus(c+415,"dmem_addr_o", false,-1, 31,0);
    tracep->declBus(c+331,"dmem_rdata_o", false,-1, 31,0);
    tracep->declBus(c+332,"wb_sel", false,-1, 1,0);
    tracep->declBus(c+333,"funct3", false,-1, 2,0);
    tracep->declBus(c+334,"funct7", false,-1, 6,0);
    tracep->declBus(c+365,"opcode", false,-1, 6,0);
    ...
    tracep->declBus(c+332,"key", false,-1, 1,0);
    tracep->declBus(c+383,"default_out", false,-1, 31,0);
    ...
    tracep->declBus(c+396,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 4; ++i) {
        tracep->declQuad(c+335+i*2,"pair_list", true,(i+0), 33,0);
    }
    for (int i = 0; i < 4; ++i) {
    ...
    tracep->declBus(c+347,"lut_out", false,-1, 31,0);
...
VL_ATTR_COLD void Vysyx_24120009_core___024root__trace_full_sub_0(Vysyx_24120009_core___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+328,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__inst_o),32);
    bufp->fullIData(oldp+329,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__pc_o),32);
    bufp->fullIData(oldp+330,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__result_o),32);
    bufp->fullIData(oldp+331,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__dmem_rdata_o),32);
    bufp->fullCData(oldp+332,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_sel),2);
    bufp->fullCData(oldp+333,((7U & (vlSelf->ysyx_24120009_core__DOT__wbu__DOT__inst_o 
                                     >> 0xcU))),3);
    bufp->fullCData(oldp+334,((vlSelf->ysyx_24120009_core__DOT__wbu__DOT__inst_o 
                               >> 0x19U)),7);
    bufp->fullQData(oldp+335,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[0]),34);
    bufp->fullQData(oldp+337,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[1]),34);
    bufp->fullQData(oldp+339,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[2]),34);
    bufp->fullQData(oldp+341,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[3]),34);
    bufp->fullIData(oldp+343,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[0]),32);
    bufp->fullIData(oldp+344,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[1]),32);
    bufp->fullIData(oldp+345,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[2]),32);
    bufp->fullIData(oldp+346,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[3]),32);
    bufp->fullIData(oldp+347,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__lut_out),32);
    bufp->fullBit(oldp+348,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__hit));
    bufp->fullBit(oldp+349,(vlSelf->clk));
    bufp->fullBit(oldp+350,(vlSelf->rst));
    bufp->fullIData(oldp+351,(vlSelf->pc_debug),32);
    bufp->fullIData(oldp+352,(vlSelf->inst_debug),32);
    bufp->fullIData(oldp+353,(vlSelf->reg_write_data_debug),32);
    bufp->fullIData(oldp+354,(vlSelf->x2_debug),32);
    bufp->fullCData(oldp+355,(vlSelf->waddr_debug),5);
    bufp->fullBit(oldp+356,(vlSelf->mem_wen_debug));
    bufp->fullBit(oldp+357,(vlSelf->mem_en_debug));
    bufp->fullIData(oldp+358,(vlSelf->Op1_debug),32);
    bufp->fullIData(oldp+359,(vlSelf->Op2_debug),32);
    bufp->fullBit(oldp+360,(vlSelf->rf_we_debug));
    bufp->fullBit(oldp+361,(vlSelf->wbu_active_debug));
    bufp->fullIData(oldp+362,(vlSelf->imem_addr_debug),32);
    bufp->fullIData(oldp+363,(vlSelf->pc_plus4_debug),32);
    bufp->fullCData(oldp+364,(vlSelf->wb_sel_debug),2);
    bufp->fullCData(oldp+365,(vlSelf->opcode_debug),7);
    bufp->fullBit(oldp+366,(vlSelf->pc_wen_debug));
    bufp->fullBit(oldp+367,(vlSelf->mem_active_debug));
