...
VL_ATTR_COLD void Vysyx_24120009_core___024root__trace_init_sub__TOP__0(Vysyx_24120009_core___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+347,"pc_debug", false,-1, 31,0);
    tracep->declBus(c+348,"inst_debug", false,-1, 31,0);
    tracep->declBus(c+349,"reg_write_data_debug", false,-1, 31,0);
    tracep->declBus(c+350,"x2_debug", false,-1, 31,0);
    tracep->declBus(c+351,"waddr_debug", false,-1, 4,0);
    tracep->declBit(c+352,"mem_wen_debug", false,-1);
    tracep->declBit(c+353,"mem_en_debug", false,-1);
    tracep->declBus(c+354,"Op1_debug", false,-1, 31,0);
    tracep->declBus(c+355,"Op2_debug", false,-1, 31,0);
    tracep->declBit(c+356,"rf_we_debug", false,-1);
    tracep->declBit(c+357,"wbu_active_debug", false,-1);
    tracep->declBus(c+358,"imem_addr_debug", false,-1, 31,0);
    tracep->declBus(c+359,"pc_plus4_debug", false,-1, 31,0);
    tracep->declBus(c+360,"wb_sel_debug", false,-1, 1,0);
    tracep->declBus(c+361,"opcode_debug", false,-1, 6,0);
    ...
    tracep->declBit(c+356,"rf_we_debug", false,-1);
    tracep->declBit(c+357,"wbu_active_debug", false,-1);
    tracep->declBus(c+347,"imem_addr_debug", false,-1, 31,0);
    tracep->declBus(c+359,"pc_plus4_debug", false,-1, 31,0);
    tracep->declBus(c+360,"wb_sel_debug", false,-1, 1,0);
    tracep->declBus(c+361,"opcode_debug", false,-1, 6,0);
    tracep->declBus(c+72,"reg_write_data", false,-1, 31,0);
    tracep->declBus(c+369,"alu_op", false,-1, 4,0);
    ...
    tracep->declBus(c+372,"wb_sel", false,-1, 1,0);
    tracep->declBus(c+75,"Op1", false,-1, 31,0);
    tracep->declBus(c+76,"Op2", false,-1, 31,0);
    tracep->declBus(c+373,"pc_plus4", false,-1, 31,0);
    ...
    tracep->declBit(c+357,"pc_wen", false,-1);
    tracep->declBus(c+347,"pc_from_IFU_to_IDU", false,-1, 31,0);
    tracep->declBus(c+348,"inst_from_IFU_to_IDU", false,-1, 31,0);
    ...
    tracep->declBus(c+354,"op1_result", false,-1, 31,0);
    ...
    tracep->declBus(c+86,"out", false,-1, 31,0);
    tracep->declBus(c+98,"key", false,-1, 4,0);
    tracep->declBus(c+378,"default_out", false,-1, 31,0);
    tracep->declArray(c+112,"lut", false,-1, 406,0);
    ...
    tracep->declBus(c+383,"RESET_VAL", false,-1, 4,0);
    tracep->declBit(c+345,"clk", false,-1);
    tracep->declBit(c+346,"rst", false,-1);
    ...
    tracep->declBus(c+178,"out", false,-1, 0,0);
    tracep->declBus(c+175,"key", false,-1, 2,0);
    tracep->declBus(c+387,"default_out", false,-1, 0,0);
    tracep->declBus(c+179,"lut", false,-1, 23,0);
    ...
    tracep->declBit(c+345,"clk", false,-1);
    tracep->declBit(c+346,"rst", false,-1);
    tracep->declBus(c+348,"din", false,-1, 31,0);
    ...
    tracep->declBit(c+345,"clk", false,-1);
    tracep->declBit(c+346,"rst", false,-1);
    tracep->declBus(c+347,"din", false,-1, 31,0);
    ...
    tracep->declBus(c+394,"imem_addr", false,-1, 31,0);
    tracep->declBus(c+227,"inst", false,-1, 31,0);
    tracep->declBus(c+378,"exception", false,-1, 31,0);
    ...
    tracep->declBit(c+362,"mem_en", false,-1);
    tracep->declBit(c+363,"mem_wen", false,-1);
    tracep->declBus(c+256,"dmem_addr_o", false,-1, 31,0);
    ...
    tracep->declBus(c+256,"dmem_addr", false,-1, 31,0);
    tracep->declBus(c+255,"control", false,-1, 2,0);
    tracep->declBus(c+89,"data_out", false,-1, 31,0);
    tracep->declBus(c+259,"shift_amount", false,-1, 1,0);
    tracep->declBus(c+260,"shifted_data", false,-1, 31,0);
    tracep->declBus(c+261,"zero_ext_byte", false,-1, 31,0);
    tracep->declBus(c+262,"zero_ext_half", false,-1, 31,0);
    tracep->declBus(c+263,"sign_ext_byte", false,-1, 31,0);
    tracep->declBus(c+264,"sign_ext_half", false,-1, 31,0);
    ...
    tracep->declBus(c+288,"key", false,-1, 9,0);
    tracep->declArray(c+399,"lut", false,-1, 103,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+397,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+398,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+385,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+255,"out", false,-1, 2,0);
    tracep->declBus(c+288,"key", false,-1, 9,0);
    tracep->declBus(c+403,"default_out", false,-1, 2,0);
    tracep->declArray(c+399,"lut", false,-1, 103,0);
    ...
    tracep->declBus(c+254,"wmask", false,-1, 7,0);
    tracep->declBus(c+259,"shift_amount", false,-1, 1,0);
    tracep->declBus(c+291,"base_mask", false,-1, 7,0);
    tracep->declBus(c+254,"shifted_mask", false,-1, 7,0);
    tracep->pushNamePrefix("mem_mux_write ");
    tracep->declBus(c+385,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+385,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+397,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+291,"out", false,-1, 7,0);
    tracep->declBus(c+255,"key", false,-1, 2,0);
    tracep->declQuad(c+406,"lut", false,-1, 32,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+385,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+385,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+397,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+291,"out", false,-1, 7,0);
    tracep->declBus(c+255,"key", false,-1, 2,0);
    tracep->declBus(c+408,"default_out", false,-1, 7,0);
    tracep->declQuad(c+406,"lut", false,-1, 32,0);
    ...
    tracep->declBus(c+292,"lut_out", false,-1, 7,0);
    ...
    tracep->declBus(c+376,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+345,"clk", false,-1);
    ...
    tracep->declBit(c+357,"pc_wen", false,-1);
    tracep->declBus(c+348,"inst_from_IFU", false,-1, 31,0);
    tracep->declBit(c+357,"wbu_active", false,-1);
    tracep->declBus(c+359,"pc_plus4_debug", false,-1, 31,0);
    tracep->declBus(c+360,"wb_sel_debug", false,-1, 1,0);
    tracep->declBus(c+361,"opcode_debug", false,-1, 6,0);
    tracep->declBus(c+359,"pc_plus4", false,-1, 31,0);
    tracep->declBus(c+326,"inst_o", false,-1, 31,0);
    tracep->declBus(c+327,"pc_o", false,-1, 31,0);
    tracep->declBus(c+328,"result_o", false,-1, 31,0);
    tracep->declBus(c+410,"dmem_addr_o", false,-1, 31,0);
    tracep->declBus(c+329,"dmem_rdata_o", false,-1, 31,0);
    tracep->declBus(c+330,"wb_sel", false,-1, 1,0);
    tracep->declBus(c+257,"funct3", false,-1, 2,0);
    tracep->declBus(c+258,"funct7", false,-1, 6,0);
    tracep->declBus(c+361,"opcode", false,-1, 6,0);
    ...
    tracep->declBus(c+326,"dout", false,-1, 31,0);
    tracep->declBit(c+382,"wen", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+378,"default_out", false,-1, 31,0);
    tracep->declArray(c+364,"lut", false,-1, 135,0);
    ...
    tracep->declBus(c+391,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 4; ++i) {
        tracep->declQuad(c+331+i*2,"pair_list", true,(i+0), 33,0);
    }
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+68+i*1,"key_list", true,(i+0), 1,0);
    }
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+339+i*1,"data_list", true,(i+0), 31,0);
    }
...
VL_ATTR_COLD void Vysyx_24120009_core___024root__trace_full_sub_0(Vysyx_24120009_core___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+256,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__dmem_addr_o),32);
    bufp->fullCData(oldp+257,((7U & (vlSelf->ysyx_24120009_core__DOT__inst_from_MEM_to_WBU 
                                     >> 0xcU))),3);
    bufp->fullCData(oldp+258,((vlSelf->ysyx_24120009_core__DOT__inst_from_MEM_to_WBU 
                               >> 0x19U)),7);
    bufp->fullCData(oldp+259,((3U & vlSelf->ysyx_24120009_core__DOT__mem__DOT__dmem_addr_o)),2);
    bufp->fullIData(oldp+260,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__shifted_data),32);
    bufp->fullIData(oldp+261,((0xffU & vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__shifted_data)),32);
    bufp->fullIData(oldp+262,((0xffffU & vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__shifted_data)),32);
    bufp->fullIData(oldp+263,((((- (IData)((1U & (vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__shifted_data 
                                                  >> 7U)))) 
                                << 8U) | (0xffU & vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__shifted_data))),32);
    bufp->fullIData(oldp+264,((((- (IData)((1U & (vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__shifted_data 
                                                  >> 0xfU)))) 
                                << 0x10U) | (0xffffU 
    ...
    bufp->fullWData(oldp+265,(__Vtemp_hdb58eddb__0),175);
    bufp->fullQData(oldp+271,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__pair_list[0]),35);
    bufp->fullQData(oldp+273,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__pair_list[1]),35);
    bufp->fullQData(oldp+275,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__pair_list[2]),35);
    bufp->fullQData(oldp+277,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__pair_list[3]),35);
    bufp->fullQData(oldp+279,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__pair_list[4]),35);
    bufp->fullIData(oldp+281,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+282,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+283,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+284,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+285,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__data_list[4]),32);
    bufp->fullIData(oldp+286,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+287,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__alignment_network__DOT__mem_mux__DOT__i0__DOT__hit));
    bufp->fullSData(oldp+288,(vlSelf->ysyx_24120009_core__DOT__mem__DOT____Vcellinp__mem_acces_ctl_mux__key),10);
    bufp->fullCData(oldp+289,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__mem_acces_ctl_mux__DOT__i0__DOT__lut_out),3);
    bufp->fullBit(oldp+290,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__mem_acces_ctl_mux__DOT__i0__DOT__hit));
    bufp->fullCData(oldp+291,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__wmask_gen__DOT__base_mask),8);
    bufp->fullCData(oldp+292,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__wmask_gen__DOT__mem_mux_write__DOT__i0__DOT__lut_out),8);
    bufp->fullBit(oldp+293,(vlSelf->ysyx_24120009_core__DOT__mem__DOT__wmask_gen__DOT__mem_mux_write__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+294,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[0]),32);
    bufp->fullIData(oldp+295,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[1]),32);
    bufp->fullIData(oldp+296,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[2]),32);
    bufp->fullIData(oldp+297,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[3]),32);
    bufp->fullIData(oldp+298,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[4]),32);
    bufp->fullIData(oldp+299,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[5]),32);
    bufp->fullIData(oldp+300,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[6]),32);
    bufp->fullIData(oldp+301,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[7]),32);
    bufp->fullIData(oldp+302,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[8]),32);
    bufp->fullIData(oldp+303,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[9]),32);
    bufp->fullIData(oldp+304,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[10]),32);
    bufp->fullIData(oldp+305,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[11]),32);
    bufp->fullIData(oldp+306,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[12]),32);
    bufp->fullIData(oldp+307,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[13]),32);
    bufp->fullIData(oldp+308,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[14]),32);
    bufp->fullIData(oldp+309,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[15]),32);
    bufp->fullIData(oldp+310,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[16]),32);
    bufp->fullIData(oldp+311,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[17]),32);
    bufp->fullIData(oldp+312,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[18]),32);
    bufp->fullIData(oldp+313,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[19]),32);
    bufp->fullIData(oldp+314,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[20]),32);
    bufp->fullIData(oldp+315,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[21]),32);
    bufp->fullIData(oldp+316,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[22]),32);
    bufp->fullIData(oldp+317,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[23]),32);
    bufp->fullIData(oldp+318,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[24]),32);
    bufp->fullIData(oldp+319,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[25]),32);
    bufp->fullIData(oldp+320,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[26]),32);
    bufp->fullIData(oldp+321,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[27]),32);
    bufp->fullIData(oldp+322,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[28]),32);
    bufp->fullIData(oldp+323,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[29]),32);
    bufp->fullIData(oldp+324,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[30]),32);
    bufp->fullIData(oldp+325,(vlSelf->ysyx_24120009_core__DOT__u_RegisterFile__DOT__rf[31]),32);
    bufp->fullIData(oldp+326,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__inst_o),32);
    bufp->fullIData(oldp+327,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__pc_o),32);
    bufp->fullIData(oldp+328,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__result_o),32);
    bufp->fullIData(oldp+329,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__dmem_rdata_o),32);
    bufp->fullCData(oldp+330,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_sel),2);
    bufp->fullQData(oldp+331,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[0]),34);
    bufp->fullQData(oldp+333,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[1]),34);
    bufp->fullQData(oldp+335,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[2]),34);
    bufp->fullQData(oldp+337,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__pair_list[3]),34);
    bufp->fullIData(oldp+339,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[0]),32);
    bufp->fullIData(oldp+340,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[1]),32);
    bufp->fullIData(oldp+341,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[2]),32);
    bufp->fullIData(oldp+342,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__data_list[3]),32);
    bufp->fullIData(oldp+343,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__lut_out),32);
    bufp->fullBit(oldp+344,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__wb_mux__DOT__i1__DOT__hit));
    bufp->fullBit(oldp+345,(vlSelf->clk));
    bufp->fullBit(oldp+346,(vlSelf->rst));
    bufp->fullIData(oldp+347,(vlSelf->pc_debug),32);
    bufp->fullIData(oldp+348,(vlSelf->inst_debug),32);
    bufp->fullIData(oldp+349,(vlSelf->reg_write_data_debug),32);
    bufp->fullIData(oldp+350,(vlSelf->x2_debug),32);
    bufp->fullCData(oldp+351,(vlSelf->waddr_debug),5);
    bufp->fullBit(oldp+352,(vlSelf->mem_wen_debug));
    bufp->fullBit(oldp+353,(vlSelf->mem_en_debug));
    bufp->fullIData(oldp+354,(vlSelf->Op1_debug),32);
    bufp->fullIData(oldp+355,(vlSelf->Op2_debug),32);
    bufp->fullBit(oldp+356,(vlSelf->rf_we_debug));
    bufp->fullBit(oldp+357,(vlSelf->wbu_active_debug));
    bufp->fullIData(oldp+358,(vlSelf->imem_addr_debug),32);
    bufp->fullIData(oldp+359,(vlSelf->pc_plus4_debug),32);
    bufp->fullCData(oldp+360,(vlSelf->wb_sel_debug),2);
    bufp->fullCData(oldp+361,(vlSelf->opcode_debug),7);
    bufp->fullBit(oldp+362,(((3U == (IData)(vlSelf->opcode_debug)) 
                             | (0x23U == (IData)(vlSelf->opcode_debug)))));
    bufp->fullBit(oldp+363,((0x23U == (IData)(vlSelf->opcode_debug))));
    ...
    bufp->fullWData(oldp+364,(__Vtemp_h650a5f8e__0),136);
    bufp->fullCData(oldp+369,(vlSelf->ysyx_24120009_core__DOT__alu_op),5);
    bufp->fullBit(oldp+370,(vlSelf->ysyx_24120009_core__DOT__mem_en));
    bufp->fullBit(oldp+371,(vlSelf->ysyx_24120009_core__DOT__mem_wen));
    bufp->fullCData(oldp+372,(vlSelf->ysyx_24120009_core__DOT__wb_sel),2);
    bufp->fullIData(oldp+373,(vlSelf->ysyx_24120009_core__DOT__pc_plus4),32);
    ...
    bufp->fullIData(oldp+379,(0x25U),32);
    bufp->fullIData(oldp+380,(0xbU),32);
    bufp->fullIData(oldp+381,(0x80000000U),32);
    bufp->fullBit(oldp+382,(1U));
    bufp->fullCData(oldp+383,(0U),5);
    bufp->fullIData(oldp+384,(6U),32);
    bufp->fullIData(oldp+385,(3U),32);
    bufp->fullIData(oldp+386,(1U),32);
    bufp->fullBit(oldp+387,(0U));
    bufp->fullIData(oldp+388,(4U),32);
    bufp->fullIData(oldp+389,(6U),32);
    bufp->fullIData(oldp+390,(2U),32);
    bufp->fullIData(oldp+391,(0x22U),32);
    bufp->fullIData(oldp+392,(2U),32);
    bufp->fullIData(oldp+393,(4U),32);
    bufp->fullIData(oldp+394,(vlSelf->ysyx_24120009_core__DOT__ifu__DOT__imem_addr),32);
    bufp->fullIData(oldp+395,(0x23U),32);
    bufp->fullIData(oldp+396,(5U),32);
    ...
    bufp->fullWData(oldp+399,(__Vtemp_ha516852c__0),104);
    bufp->fullCData(oldp+403,(0U),3);
    bufp->fullIData(oldp+404,(0xdU),32);
    bufp->fullIData(oldp+405,(8U),32);
    bufp->fullQData(oldp+406,(0x83c81801ULL),33);
    bufp->fullCData(oldp+408,(0U),8);
    bufp->fullIData(oldp+409,(3U),32);
    bufp->fullIData(oldp+410,(vlSelf->ysyx_24120009_core__DOT__wbu__DOT__dmem_addr_o),32);
}
