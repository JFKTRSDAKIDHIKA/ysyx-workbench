...
class alignas(VL_CACHE_LINE_BYTES) VCore___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ Core__DOT___ifu_io_arbiter_valid;
        CData/*2:0*/ Core__DOT__ifu__DOT__state;
        ...
        CData/*0:0*/ Core__DOT__ifu__DOT___GEN_6;
        CData/*0:0*/ Core__DOT__ifu__DOT____VdfgTmp_h3a4270d2__0;
    ...
    struct {
        ...
        CData/*0:0*/ Core__DOT__arbiter__DOT__state;
