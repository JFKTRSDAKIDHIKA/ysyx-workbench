...
VL_ATTR_COLD void VysyxSoCFull___024root___eval_postponed__TOP(VysyxSoCFull___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(vlSelf->ysyxSoCFull__DOT__sdram__DOT____Vstrobe4)) {
        VL_WRITEF("Read data at mem[%0#][%0#][%0#] = %0x\n",
                  ...
                  9,(0x1ffU & (IData)(vlSelf->ysyxSoCFull__DOT__asic__DOT__lsdram_apb__DOT__msdram__DOT__u_sdram_ctrl__DOT__addr_q)),
                  16,(IData)(vlSelf->ysyxSoCFull__DOT__sdram__DOT__dq_out));
        Verilated::runFlushCallbacks();
    ...
    if (VL_UNLIKELY(vlSelf->ysyxSoCFull__DOT__sdram__DOT____Vstrobe5)) {
        VL_WRITEF("Read data at mem[%0#][%0#][%0#] = %0x\n",
                  ...
                  13,vlSelf->ysyxSoCFull__DOT__sdram__DOT__active_row
                  [vlSelf->ysyxSoCFull__DOT__asic__DOT__lsdram_apb__DOT__msdram__DOT__u_sdram_ctrl__DOT__bank_q],
                  32,((IData)(1U) + (0x1ffU & (IData)(vlSelf->ysyxSoCFull__DOT__asic__DOT__lsdram_apb__DOT__msdram__DOT__u_sdram_ctrl__DOT__addr_q))),
                  16,(IData)(vlSelf->ysyxSoCFull__DOT__sdram__DOT__dq_out));
        Verilated::runFlushCallbacks();
