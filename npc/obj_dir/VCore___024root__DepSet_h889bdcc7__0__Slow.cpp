...
#endif
            VL_FATAL_MT("npc-chisel/generated/Core.sv", 974, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void VCore___024root___stl_sequent__TOP__0(VCore___024root* vlSelf) {
    ...
    vlSelf->Core__DOT__lsu__DOT__alignment_network__DOT__shifted_data 
        = (vlSelf->Core__DOT___arbiter_io_lsu_r_data 
           >> (0x18U & (vlSelf->Core__DOT__lsu__DOT__lsu_reg_dmem_addr 
                        << 3U)));
    __Vtemp_11[0U] = (((- (IData)((1U & (vlSelf->Core__DOT__lsu__DOT__alignment_network__DOT__shifted_data 
                                         >> 7U)))) 
                       << 8U) | (0xffU & vlSelf->Core__DOT__lsu__DOT__alignment_network__DOT__shifted_data));
    __Vtemp_11[1U] = (((- (IData)((1U & (vlSelf->Core__DOT__lsu__DOT__alignment_network__DOT__shifted_data 
                                         >> 0xfU)))) 
                       << 0x10U) | (0xffffU & vlSelf->Core__DOT__lsu__DOT__alignment_network__DOT__shifted_data));
    __Vtemp_11[2U] = (IData)((QData)((IData)(vlSelf->Core__DOT___arbiter_io_lsu_r_data)));
    __Vtemp_11[3U] = (IData)(((QData)((IData)(vlSelf->Core__DOT___arbiter_io_lsu_r_data)) 
                              >> 0x20U));
    __Vtemp_11[4U] = (0xffU & vlSelf->Core__DOT__lsu__DOT__alignment_network__DOT__shifted_data);
    __Vtemp_11[5U] = (0xffffU & vlSelf->Core__DOT__lsu__DOT__alignment_network__DOT__shifted_data);
    __Vtemp_11[6U] = 0U;
    __Vtemp_11[7U] = 0U;
