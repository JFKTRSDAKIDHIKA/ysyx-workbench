...
#endif
            VL_FATAL_MT("npc-chisel/generated/Core.sv", 980, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void VCore___024root___ctor_var_reset(VCore___024root* vlSelf) {
    ...
    vlSelf->Core__DOT___lsu_io_memory_r_ready = VL_RAND_RESET_I(1);
    ...
    vlSelf->Core__DOT__lsu__DOT__unnamedblk1__DOT___GEN_5 = VL_RAND_RESET_I(8);
