...
#endif
            VL_FATAL_MT("npc-chisel/generated/Core.sv", 1235, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void VCore___024root___stl_sequent__TOP__0(VCore___024root* vlSelf) {
    ...
    if (vlSelf->Core__DOT__xbar__DOT__isMem) {
        vlSelf->Core__DOT__xbar__DOT___GEN_3 = ((~ (IData)(vlSelf->Core__DOT__sram__DOT____VdfgTmp_h93f383d4__0)) 
                                                & ((1U 
                                                    == (IData)(vlSelf->Core__DOT__sram__DOT__state)) 
                                                   & (IData)(vlSelf->Core__DOT__sram__DOT___sram_wt_res_valid)));
        vlSelf->Core__DOT__xbar__DOT___GEN_8 = (1U 
                                                == (IData)(vlSelf->Core__DOT__xbar__DOT__state));
        vlSelf->Core__DOT__xbar__DOT___GEN_0 = ((~ (IData)(vlSelf->reset)) 
                                                & (0U 
                                                   == (IData)(vlSelf->Core__DOT__sram__DOT__state)));
        ...
        vlSelf->Core__DOT__xbar__DOT___GEN_3 = 0U;
        vlSelf->Core__DOT__xbar__DOT___GEN_8 = 0U;
        vlSelf->Core__DOT__xbar__DOT___GEN_0 = 0U;
    ...
    if ((0U == (IData)(vlSelf->Core__DOT__xbar__DOT__state))) {
        ...
        vlSelf->Core__DOT___xbar_io_sram_ar_valid = 
            ((IData)(vlSelf->Core__DOT__xbar__DOT___GEN_8) 
             & (IData)(vlSelf->Core__DOT___arbiter_io_axi_ar_valid));
        if ((1U == (IData)(vlSelf->Core__DOT__xbar__DOT__state))) {
            vlSelf->Core__DOT___xbar_io_in_ar_ready 
                = vlSelf->Core__DOT__xbar__DOT___GEN_0;
            vlSelf->Core__DOT___xbar_io_in_r_valid 
                = vlSelf->Core__DOT__xbar__DOT___GEN_5;
...
VL_ATTR_COLD void VCore___024root___ctor_var_reset(VCore___024root* vlSelf) {
    ...
    vlSelf->Core__DOT___uart_io_axi_aw_ready = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT___uart_io_axi_w_ready = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT___uart_io_axi_b_valid = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT___uart_io_axi_ar_ready = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT___uart_io_axi_r_valid = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT___uart_io_axi_r_data = VL_RAND_RESET_I(32);
    vlSelf->Core__DOT___xbar_io_in_ar_ready = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT___xbar_io_in_r_valid = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT___xbar_io_in_r_data = VL_RAND_RESET_I(32);
    vlSelf->Core__DOT___xbar_io_uart_aw_valid = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT___xbar_io_uart_aw_addr = VL_RAND_RESET_I(32);
    vlSelf->Core__DOT___xbar_io_uart_w_data = VL_RAND_RESET_I(32);
    vlSelf->Core__DOT___xbar_io_sram_ar_valid = VL_RAND_RESET_I(1);
    ...
    vlSelf->Core__DOT___arbiter_io_axi_aw_addr = VL_RAND_RESET_I(32);
    vlSelf->Core__DOT___arbiter_io_axi_w_data = VL_RAND_RESET_I(32);
    vlSelf->Core__DOT___arbiter_io_axi_w_strb = VL_RAND_RESET_I(4);
    vlSelf->Core__DOT___arbiter_io_axi_b_ready = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT___arbiter_io_axi_ar_valid = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT___arbiter_io_axi_ar_addr = VL_RAND_RESET_I(32);
    vlSelf->Core__DOT___arbiter_io_axi_r_ready = VL_RAND_RESET_I(1);
    ...
    vlSelf->Core__DOT___lsu_io_arbiter_valid = VL_RAND_RESET_I(1);
    ...
    vlSelf->Core__DOT__ifu__DOT___GEN_6 = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT__ifu__DOT____VdfgTmp_h3a4270d2__0 = 0;
    ...
    vlSelf->Core__DOT__lsu__DOT____VdfgTmp_h4810bc75__0 = 0;
    vlSelf->Core__DOT__lsu__DOT____VdfgTmp_hbdad3c0b__0 = 0;
    ...
    vlSelf->Core__DOT__arbiter__DOT__state = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT__arbiter__DOT___GEN_0 = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT__arbiter__DOT____VdfgTmp_h41ece670__0 = 0;
    vlSelf->Core__DOT__arbiter__DOT____VdfgTmp_hd26a19fd__0 = 0;
    vlSelf->Core__DOT__xbar__DOT__isUart = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT__xbar__DOT__isMem = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT__xbar__DOT__state = VL_RAND_RESET_I(2);
    vlSelf->Core__DOT__xbar__DOT___GEN_0 = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT__xbar__DOT___GEN_1 = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT__xbar__DOT___GEN_3 = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT__xbar__DOT___GEN_5 = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT__xbar__DOT___GEN_6 = VL_RAND_RESET_I(32);
    vlSelf->Core__DOT__xbar__DOT___GEN_8 = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT__xbar__DOT___GEN_9 = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT__xbar__DOT___GEN_10 = VL_RAND_RESET_I(1);
    vlSelf->Core__DOT__xbar__DOT__unnamedblk1__DOT___GEN_11 = VL_RAND_RESET_I(8);
    vlSelf->Core__DOT__xbar__DOT____VdfgTmp_h7e119c30__0 = 0;
    vlSelf->Core__DOT__xbar__DOT____VdfgTmp_h9f2d9de7__0 = 0;
    ...
    vlSelf->Core__DOT__uart__DOT__uartRaw__DOT__rresp = VL_RAND_RESET_I(2);
    vlSelf->Core__DOT__uart__DOT__uartRaw__DOT__uart_reg = VL_RAND_RESET_I(32);
    vlSelf->Core__DOT__uart__DOT__uartRaw__DOT__state = VL_RAND_RESET_I(2);
    vlSelf->Core__DOT__uart__DOT__uartRaw__DOT__next_state = VL_RAND_RESET_I(2);
    vlSelf->__VdfgTmp_hd07d15e1__0 = 0;
    vlSelf->__Vfunc_Core__DOT__sram__DOT__sram__DOT__pmem_read__2__Vfuncout = 0;
    vlSelf->__Vtableidx1 = 0;
    vlSelf->__Vdly__Core__DOT__xbar__DOT__state = VL_RAND_RESET_I(2);
