...
void VysyxSoCFull___024root__trace_chg_sub_0(VysyxSoCFull___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[0xdU])) {
        ...
        bufp->chgBit(oldp+1070,(vlSelf->ysyxSoCFull__DOT____Vcellinp__sdram_chip_0__cas));
        ...
        bufp->chgBit(oldp+1075,(vlSelf->ysyxSoCFull__DOT____Vcellinp__sdram_chip_2__cas));
