...
void Vysyx_24120009_core___024root__trace_chg_sub_0(Vysyx_24120009_core___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgCData(oldp+96,(vlSelf->ysyx_24120009_core__DOT__bresp_wire),2);
        bufp->chgBit(oldp+97,(vlSelf->ysyx_24120009_core__DOT__arvalid_wire));
        bufp->chgBit(oldp+98,(vlSelf->ysyx_24120009_core__DOT__arready_wire));
        bufp->chgIData(oldp+99,(vlSelf->ysyx_24120009_core__DOT__araddr_wire),32);
        bufp->chgBit(oldp+100,(vlSelf->ysyx_24120009_core__DOT__rvalid_wire));
        bufp->chgBit(oldp+101,(vlSelf->ysyx_24120009_core__DOT__rready_wire));
        bufp->chgIData(oldp+102,(vlSelf->ysyx_24120009_core__DOT__rdata_wire),32);
        bufp->chgCData(oldp+103,(vlSelf->ysyx_24120009_core__DOT__rresp_wire),2);
