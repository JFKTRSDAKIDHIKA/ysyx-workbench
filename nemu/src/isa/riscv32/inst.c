...
static uint32_t mtvec, mepc, mcause = 0;
...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 001 ????? 1110011", csrw   , I, mtvec = src1);
  ...
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , N, mepc = s->pc; s->dnpc = mtvec; mcause = 0x8;); 
