...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? ??? ????? 00001 11", fence , N, NEMUTRAP(s->pc, R(10))); // or similar logic
  INSTPAT("0000000 00000 00000 000 00000 00000 11", ecall , N, NEMUTRAP(s->pc, R(10))); // or similar logic
